...
describe('Enhancer fail method tests', () => {
	test('If the items enhancement level is less than 15, the durability of the item is decreased by 5.', () => {
		...
		expect(
			fail({ name: 'Staff', enhancement: 14, durabilty: 20 })
		).toEqual({
			name: 'Staff',
			enhancement: 14,
			durabilty: 15
	...
	test('If the items enhancement level is 15 or more, the durability of the item is decreased by 10.', () => {
		...
		expect(
			fail({ name: 'Staff', enhancement: 15, durabilty: 20 })
		).toEqual({
			name: 'Staff',
			enhancement: 15,
			durabilty: 10
	...
	test('If the items enhancement level is greater than 16, the enhancement level decreases by 1 (17 goes down to 16, 18 goes down to 17).', () => {
		...
		expect(
			fail({ name: 'Staff', enhancement: 18, durabilty: 20 })
		).toEqual({
			name: 'Staff',
			enhancement: 17,
			durabilty: 10
...
describe('Enhancer get method tests', () => {
	test('Adds level to name i.e: [+7] Staff', () => {
		expect(
			get({ name: 'Staff', enhancement: 7, durabilty: 20 })
		).toEqual({
			name: '[+7] Staff',
			enhancement: 7,
			durabilty: 20
